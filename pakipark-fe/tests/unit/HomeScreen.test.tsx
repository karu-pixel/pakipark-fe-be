...
describe('HomeScreen', () => {
  it('renders expected root and text content', () => {
    ...
    const title = children[0] as any;
    const subtitle = children[1] as any;
    const badge = children[2] as any;
    ...
    expect((badgeChildren[0] as any).props.children).toEqual(['Environment: ', 'development']);
  });
});
