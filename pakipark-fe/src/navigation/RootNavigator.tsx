    ...
    <NavigationContainer theme={navigationTheme}>
      ...
      >
        <Stack.Screen name="Auth">
          {({ navigation }) => (
            <AuthScreen
              onAuthSuccess={(role) => navigation.replace(isManagementRole(role) ? 'AdminHome' : 'CustomerHome')}
        ...
        <Stack.Screen name="AdminHome">
          {() => <AdminHomeScreen onLogoutToAuth={onLogoutToAuth} onNavigateToPakiShip={onNavigateToPakiShip} />}
        </Stack.Screen>
