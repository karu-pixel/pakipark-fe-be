            ...
            <View style={styles.heroContent}>
              <View style={styles.heroTop}>
                ...
                <View style={styles.heroInfo}>
                  <Text style={styles.heroName} numberOfLines={1}>{`${profileData.first_name} ${profileData.last_name}`.trim() || 'Guest User'}</Text>
                  <Text style={styles.heroEmail} numberOfLines={1}>{profileData.email || profileData.mobile_number || 'No contact added'}</Text>
...
const styles = StyleSheet.create({
  ...
  headerBar: { minHeight: 56, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 10, backgroundColor: COLORS.surface, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  backButton: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center' },
  ...
  heroContent: { padding: 18, zIndex: 1 },
  ...
  heroInfo: { alignItems: 'center', width: '100%', paddingHorizontal: 8 },
  heroName: { maxWidth: '100%', fontSize: 19, fontWeight: '900', color: COLORS.surface, marginBottom: 3, textAlign: 'center' },
  ...
  locationBadgeText: { maxWidth: 210, fontSize: 10, fontWeight: '800', color: 'rgba(255,255,255,0.7)' },
