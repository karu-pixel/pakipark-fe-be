...
export class UserCompatController extends CompatController {
  ...
  @Post('2fa/setup') setup2fa(@Req() req: Request, @Res() res: Response) { return this.call('user', 'setup2FA', req, res); }
  @Post('2fa/verify') verify2fa(@Req() req: Request, @Res() res: Response) { return this.call('user', 'verify2FA', req, res); }
  @Post('2fa/disable') disable2fa(@Req() req: Request, @Res() res: Response) { return this.call('user', 'disable2FA', req, res); }
